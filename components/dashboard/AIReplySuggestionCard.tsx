...
export function AIReplySuggestionCard({ review }: AIReplySuggestionCardProps) {
  ...
  return (
    <div className="glass-card p-6 h-full flex flex-col">
      ...
      {/* Reply box */}
      <div className="flex-1 rounded-xl bg-gradient-to-br from-[#D4713A]/[0.06] to-[#1A6BFF]/[0.06] border border-white/[0.08] p-3 mb-3 min-h-[80px]">
        {reply ? (
